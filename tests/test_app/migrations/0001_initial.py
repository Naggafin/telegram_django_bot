	...
	operations = [
		migrations.CreateModel(
			...
			fields=[
				...
				(
					"info",
					models.TextField(
						blank=True, help_text="extra info about category", null=True
					),
				),
			],
			options={
		...
		migrations.CreateModel(
			...
			fields=[
				...
				(
					"author_id",
					models.PositiveIntegerField(help_text="write positive number"),
				),
				(
					"used_material",
					models.FloatField(blank=True, help_text="float field", null=True),
				),
				(
					"category",
					models.ForeignKey(
		...
		migrations.CreateModel(
			...
			fields=[
				...
				(
					"size",
					models.ForeignKey(
						on_delete=django.db.models.deletion.CASCADE, to="test_app.size"
					),
				),
			],
		),
		migrations.AddField(
			...
			field=models.ManyToManyField(
				...
				through="test_app.EntitySizeAmount",
				to="test_app.Size",
			),
		),
		migrations.CreateModel(
