	...
	operations = [
		migrations.CreateModel(
			...
			fields=[
				...
				(
					"message_write_code_dttm",
					models.DateTimeField(blank=True, null=True),
				),
				(
					"message_write_code_context",
		...
		migrations.CreateModel(
			...
			fields=[
				...
				(
					...
					models.TextField(
						blank=True,
						help_text='InlineKeyboardMarkup список кнопок, ({"text": , "url" or "callback_data"})',
						null=True,
					),
				),
				(
					...
					models.FileField(
						blank=True,
						help_text="Файл приложение к сообщению",
						null=True,
						upload_to="",
					),
				),
			...
			fields=[
				...
				(
					...
					models.DurationField(
						help_text="минимальный период, в который может быть 1 уведомление для пользователя данного типа"
					),
				),
				(
					"priority",
					models.IntegerField(
						default=1,
						help_text="чем больше тем в первую очередь будут выполняться",
					),
				),
				(
					"botmenuelem",
					models.ForeignKey(
						help_text="какое сообщение по тригеру показываем",
		...
		migrations.CreateModel(
			...
			fields=[
				...
				(
					...
					models.ForeignKey(
						on_delete=django.db.models.deletion.PROTECT,
						to="telegram_django_bot.trigger",
					),
				),
				(
					"user",
